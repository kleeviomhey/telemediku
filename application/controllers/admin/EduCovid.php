...
class EduCovid extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/edukasicovid19', $data);
    ...
    public function addArtikel()
    {
        ...
        $this->load->view('admin/templates/admin_sidebar', $data);
        $this->load->view('admin/templates/admin_topbar', $data);
        $this->load->view('admin/edukasicovid/addartikel', $data);
        $this->load->view('admin/templates/admin_footer');
    }
    ...
    public function addNewArtikel()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Admin_model->addNewArtikel($data, 'edukasi_covid');
            $this->session->set_flashdata('message', 'Ditambahkan');
            redirect('admin/educovid/');
        }
    }
    ...
    public function deleteArtikel($id)
    {
        ...
        $this->Admin_model->deleteArtikel($id, 'edukasi_covid');
    ...
    public function editArtikel($id)
    {
        ...
        $data['artikel'] = $this->Admin_model->editArtikel($id, 'edukasi_covid')->row_array();
        $data['user'] = $this->db->get_where('admin', ['email' =>
        $this->session->userdata('email')])->row_array();
        $data['menu'] = $this->Admin_model->queryMenu();
        ...
        $this->load->view('admin/templates/admin_sidebar', $data);
        $this->load->view('admin/templates/admin_topbar', $data);
        $this->load->view('admin/edukasicovid/editArtikel', $data);
        $this->load->view('admin/templates/admin_footer');
    }
    ...
    public function updateArtikel()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Admin_model->updateArtikel();
    ...
    public function detailArtikel($id)
    {
        ...
        $data['user'] = $this->db->get_where('admin', ['email' =>
        $this->session->userdata('email')])->row_array();
        $data['detail'] = $this->Admin_model->getArtikelById($id, 'edukasi_covid');
        $data['menu'] = $this->Admin_model->queryMenu();

        $this->load->view('admin/templates/admin_header', $data);
        $this->load->view('admin/templates/admin_sidebar', $data);
        $this->load->view('admin/templates/admin_topbar', $data);
        $this->load->view('admin/edukasicovid/detailartikel', $data);
        $this->load->view('admin/templates/admin_footer');
    }
}
